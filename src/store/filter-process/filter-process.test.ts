// import { FilterPrices, FilterProcess, FilterTypeCategory, FilterTypeLevel, FilterTypeType } from '../products-api/types';
...
import { FilterProcess } from '../products-api/types';
...
describe('reducer: filterProcessSlice', () => {
  ...
  //       payload: FilterTypeType.Collection
  //     });
